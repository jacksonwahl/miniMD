...
# 1 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstdio" 1 3
...
# 40 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstdio" 3
...
# 42 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstdio" 2 3
...
# 43 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstdio" 2 3
...
# 95 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstdio" 3
...
namespace __gnu_cxx
{
# 173 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstdio" 3
...
# 1 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstring" 1 3
...
# 40 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstring" 3
...
# 43 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstring" 2 3





# 70 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstring" 3
...
# 119 "/apps/eb/software/GCCcore/8.2.0/include/c++/8.2.0/cstring" 3
...
int create_atoms(Atom &atom, int nx, int ny, int nz, double rho)
{
  ...
  int iflagall;
  MPI_Allreduce(&iflag, &iflagall, 1, (static_cast<MPI_Datatype> (static_cast<void * > (&(ompi_mpi_int)))), (static_cast<MPI_Op> (static_cast<void * > (&(ompi_mpi_op_max)))), (static_cast<MPI_Comm> (static_cast<void * > (&(ompi_mpi_comm_world)))));
...
void create_velocity(double t_request, Atom &atom, Thermo &thermo)
{
  ...
  double tmp;
  MPI_Allreduce(&vxtot, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void * > (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void * > (&(ompi_mpi_op_sum)))), (static_cast<MPI_Comm> (static_cast<void * > (&(ompi_mpi_comm_world)))));
  vxtot = tmp / atom.natoms;
  MPI_Allreduce(&vytot, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void * > (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void * > (&(ompi_mpi_op_sum)))), (static_cast<MPI_Comm> (static_cast<void * > (&(ompi_mpi_comm_world)))));
  vytot = tmp / atom.natoms;
  MPI_Allreduce(&vztot, &tmp, 1, (static_cast<MPI_Datatype> (static_cast<void * > (&(ompi_mpi_double)))), (static_cast<MPI_Op> (static_cast<void * > (&(ompi_mpi_op_sum)))), (static_cast<MPI_Comm> (static_cast<void * > (&(ompi_mpi_comm_world)))));
